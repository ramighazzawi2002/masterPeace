...
const ProfilePage = () => {
  ...
  const [profile, setProfile] = useState({
    name: "اسم المستخدم",
    bio: "مهتم بالتراث الأردني",
    about:
      "مرحبًا! أنا مهتم بالحفاظ على التراث الأردني ونشره. أشارك بانتظام في ورش العمل وأكتب مقالات عن الثقافة والتقاليد الأردنية. هدفي هو المساهمة في الحفاظ على هويتنا الثقافية للأجيال القادمة.",
    image:
      ...
      case "article":
        return (
          ...
          >
            ...
            <button
              type="submit"
              className="w-full bg-amber-600 text-white p-2 rounded hover:bg-customBrown"
            >
              إضافة المقالة
            </button>
          </form>
      ...
      <div className="bg-amber-50 min-h-screen pt-10">
        <main className="container mx-auto mt-8 p-4">
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            <div className="bg-customBrown h-32"></div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="flex items-center">
                    <div className="relative">
                      <img
                        className="w-24 h-24 rounded-full border-4 bg-black border-white -mt-12 mr-4 cursor-pointer"
                        src={profile.image}
                        alt="Profile"
                        onClick={handleImageClick}
                      />
                      <div
                        className="absolute bottom-0 right-0 bg-amber-600 rounded-full p-1 cursor-pointer"
                        onClick={handleImageClick}
                      >
                  ...
                  <button
                    type="submit"
                    className="bg-amber-600 text-white px-4 py-2 rounded hover:bg-customBrown"
                  >
                    حفظ التغييرات
                  </button>
                </form>
                ...
                <div>
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="flex items-center text-customGreen hover:text-customGreen"
                    >
          ...
          <div className="mt-8">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-xl font-semibold">المقالات</h3>
              <button
                onClick={() => openModal("article")}
                className="flex items-center text-customGreen hover:text-customGreen"
              >
                <Plus className="w-4 h-4 mr-1" /> إضافة مقالة
              </button>
            </div>
          ...
          <div className="mt-8">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-xl font-semibold">الورشات</h3>
              <button
                onClick={() => openModal("workshop")}
                className="flex items-center text-customGreen hover:text-customGreen"
              >
                <Plus className="w-4 h-4 mr-1" /> إضافة ورشة
              </button>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {workshops.map(workshop => (
                <div key={workshop.id} className="bg-white p-4 rounded shadow">
