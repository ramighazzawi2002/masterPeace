...
function Articles() {
  ...
  return (
    <>
      <SEO
        title="المقالات"
        description="اكتشف مجموعة متنوعة من المقالات حول التراث الأردني والحرف اليدوية والثقافة المحلية"
        keywords="مقالات تراثية, الثقافة الأردنية, التراث الأردني, مقالات ثقافية"
      />
