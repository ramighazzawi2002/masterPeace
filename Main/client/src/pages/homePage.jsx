  ...
  return (
    <>
      <SEO
        ...
        description="اكتشف جمال وعراقة التراث الأردني من خلال مجموعة متنوعة من الورش والمنتجات والمقالات"
        keywords="التراث الأردني, الصفحة الرئيسية, الثقافة الأردنية, الحرف اليدوية"
      />
        ...
        <section className="max-w-7xl mx-auto px-4 py-16">
          <div className="bg-customYellow rounded-xl p-8 mb-16 shadow-lg">
            ...
            <p className="text-xl text-customBrown leading-relaxed text-justify">
              التراث الأردني هو مزيج غني من التقاليد والثقافة والصمود عبر
              القرون. من أسواق عمّان النابضة بالحياة إلى المناظر الطبيعية
              الساحرة في البتراء، يعكس التراث الأردني ارتباطاً عميقاً بتاريخه
              وشعبه. استكشف فن التطريز الأردني، وتذوق الأطباق اللذيذة من المطبخ
              الأردني، واكتشف فن صناعة الفسيفساء. انضم إلينا في الاحتفال بالتراث
              الأردني، حيث كل غرزة، كل نكهة، وكل قصة تروي حكاية الأرض التي شكلها
              الزمن وحفظتها في قلوب شعبها.
            </p>
          </div>
