  ...
  return (
    <header className="bg-customBrown font-extrabold p-4 fixed top-0 left-0 w-full z-40">
      <nav className="flex justify-between items-center max-w-7xl mx-auto">
        ...
        <ul
          className={cn(
            "fixed inset-0 bg-black/90 flex flex-col justify-center items-center gap-8 text-2xl transition-all duration-300 ease-in-out md:static md:flex-row md:bg-transparent md:text-base",
